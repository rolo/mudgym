...
This means that rewards in the game are sparse and long-horizon. See the [Goal room example](examples/goal-room.md) for an example of how to customise this using Gymnasium's wrapper.
